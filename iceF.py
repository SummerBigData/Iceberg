...
def getAE():
	...
	clayers = MaxPooling2D((2, 2), padding='same')(x)
	# at this point the representation is (4, 4, 8) i.e. 128-dimensional
	x = Flatten()(clayers)
	x = Dense(128, activation='relu')(clayers)
	x = Dense(128, activation='relu')(x)
	encoded = Dense(64, activation='relu',activity_regularizer=regularizers.l1(10e-5))(x)
